...
import {WEAPONS,INFECTED,makeDirector,directorStep,circleIntersectsBox,moveCircle,lineBlocked,raySphereDistance,rayBoxDistance,chooseAimTarget,formatTime} from './core.js';
...
console.log('9/9 combat core tests passed');
